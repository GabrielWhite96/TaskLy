...
function EisenhowerSectionLP() {
  return (
    <EisenhowerSectionContainer>
      <EisenhowerImage
        src={eisenhowerImage}
        alt="App showing Eisenhower matrix feature"
      />
      <EisenhowerTextContainer>
        <EisenhowerTitle>
          Controle suas prioridades com a Matriz de Eisenhower
        </EisenhowerTitle>
        <EisenhowerSubtitle>
          Organize suas tarefas com base na urgência e importância. O app
          permite que você defina as prioridades de cada tarefa, ajudando a
